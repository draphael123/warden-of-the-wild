...
export default function Home(){
  ...
  const reset=useCallback(()=>{
    ...
    game.current={gold:260,lives:20,wave:0,score:0,state:"ready",towers:[] as Tower[],enemies:[] as Enemy[],falls:[],bolts:[] as Bolt[],particles:[] as Particle[],texts:[] as Popup[],rings:[],spawn:[] as any[],spawnClock:0,nextId:1,time:0,shake:0,flash:0,message:"Build your first elemental tower.",hover:-1,mouse:{x:500,y:300},selectedTower:-1,speed,menuSpeed:speed,combo:0,comboTimer:0,best,muted,veteran,screenShake,damageNumbers,ability:0,abilityShown:0,aiming:false,surgeMark:null};
